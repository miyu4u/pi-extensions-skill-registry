...
export const SkillRegistryToolInputSchema = Type.Object({
	...
	query: Type.Optional(Type.String({ trim: true, maxLength: 1024 })),
	names: Type.Optional(Type.Array(Type.String({ trim: true, minLength: 1 }))),
	roots: Type.Optional(Type.Array(Type.String({ trim: true, minLength: 1 }))),
	fileNames: Type.Optional(Type.Array(Type.String({ trim: true, minLength: 1 }))),
